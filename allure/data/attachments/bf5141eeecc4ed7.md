...
Locator:  getByText('completed-1789198984619')
...
Call log:
  ...
  - waiting for getByText('completed-1789198984619')
    14 × locator resolved to <div data-v-79828654="" class="v-list-item-title">completed-1789198984619</div>
       - unexpected value "visible"

```

```yaml
- text: completed-1789198984619
```
