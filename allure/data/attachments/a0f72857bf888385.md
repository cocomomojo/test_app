...
- Location: tests/e2e/todo.spec.ts:80:1
...
Locator: getByText('completed-1789207925690')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByText('completed-1789207925690')
...
- banner:
  ...
  - button "ダークモード"
- main:
  - heading "TODO リスト" [level=3]
  - progressbar: 14%
  - text: 1 / 7 タスク完了 新しい TODO を入力
  - textbox "新しい TODO を入力"
  - alert
  - button "追加" [disabled]
  - heading "フィルター" [level=4]
  - combobox:
    - text: 優先度
    - combobox "優先度"
  - alert
